...
that are ranked high across all 3 conditions—that is, for which the maximum of
the ranks is large. However we can more explicitly focus on high-ranked genes
using the fact that rank-gap statistics are also uniformly distributed
