...
We therefore adapt common graphics for displaying _p_-values to explore their
distribution.
...
One way to do this is with a stratified _Q-Q_ plot:

```{r label="rgap_qq", fig.height=4, fig.width=11, out.width="80%"}
with(d_B_limma,
  rank_gap_qq(
    signed_p_KS1, signed_p_KS2, signed_p_RT,
    n_max_rank_bins = 4))
