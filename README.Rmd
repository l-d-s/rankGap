...
Venn diagrams for this purpose.

But we expect they may be useful for exploring multivariate distributions in
...
```{r fig.height=3, fig.width=6.5, out.width="90%"}
with(
  d_B_limma,
  rank_gap_linehist(
    t.KS1, t.KS2, t.RT,
...
of genes based on their maximum rank across the 3 conditions.
